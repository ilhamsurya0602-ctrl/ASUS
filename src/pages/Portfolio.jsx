  ...
  return (
    <section className="portfolio">
      <div className="portfolio-content">
        ...
        <div className="grid">
          <div className="card">
            <img src="src/assets/produk-1.jpg" alt="Meja Kayu Jati" />
            <h3>Meja Kayu Jati</h3>
          </div>
          <div className="card">
            <img src="src/assets/produk-2.jpg" alt="Kursi Minimalis" />
            <h3>Kursi Minimalis</h3>
          </div>
          <div className="card">
            <img src="src/assets/produk-3.jpg" alt="Lemari Modern" />
            <h3>Lemari Modern</h3>
          </div>
        </div>
      </div>
